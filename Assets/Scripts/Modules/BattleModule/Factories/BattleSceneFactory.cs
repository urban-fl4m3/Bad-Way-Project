...
namespace Modules.BattleModule.Factories
{
    ...
    private  PlayerActCallbacks _playerActCallbacks;
        ...
        CameraController cameraController)
    {
        ...
        var battleScene = new BattleScene(gridController, playerActorsManager, enemyActorsManager,
            cameraController,_playerActCallbacks);
        return battleScene;
    }
        ...
        BattlePlayerControlsView battlePlayerControlsView, CameraController cameraController)
    {
        ...
        var playerCallbacks = new PlayerActCallbacks(grid, tickManager, battlePlayerControlsView,this);
        var playerManager = new BattleActManager(playerBattleActors, playerCallbacks);

        _playerActCallbacks = playerCallbacks;
